...
class TestParametricCPDBasic:
    ...
    def test_single_concept_initialization(self):
        ...
        cpd = ParametricCPD(concept='c1', parametrization=module)
...
class TestParametricCPD(unittest.TestCase):
    ...
    def test_single_concept_cpd(self):
        ...
        cpd = ParametricCPD(concept='concept_a', parametrization=module)
    ...
    def test_cpd_forward(self):
        ...
        module = nn.Linear(10, 1)
        cpd = ParametricCPD(concept='concept', parametrization=module)
    ...
    def test_cpd_with_variable(self):
        ...
        var = Variable(concept='concept', distribution=Bernoulli, size=1)
        cpd.variable = var
    ...
    def test_cpd_with_parents(self):
        ...
        module = nn.Linear(10, 1)
        parent_var = Variable(concept='parent', distribution=Bernoulli, size=1)
        cpd = ParametricCPD(concept='child', parametrization=module, parents=[parent_var])
